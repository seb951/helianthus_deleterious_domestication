...
setwd("~/Documents/domestication_load")
###
...
{bwa_aln1 = paste("bwa aln -t 6 -q 20 reference/HA412_trinity_noAltSplice_400bpmin.fa ",sub(".fq","_1.fq",individuals[i,1], fixed = T),"  >alignments/",sub(".fq","_1.fq",individuals[i,5], fixed = T), ".sai", sep = "");
bwa_aln2 = paste("bwa aln -t 6 -q 20 reference/HA412_trinity_noAltSplice_400bpmin.fa ",sub(".fq","_2.fq",individuals[i,1], fixed = T),"  >alignments/",sub(".fq","_2.fq",individuals[i,5], fixed = T), ".sai", sep = "")}

	if((individuals[i,3] == "ill") & (individuals[i,4] == "Ill1.3")) # old illumina quality format
{bwa_aln1 = paste("bwa aln -t 6 -I -q 20 reference/HA412_trinity_noAltSplice_400bpmin.fa ",sub(".fq","_1.fq",individuals[i,1], fixed = T),"  >alignments/",sub(".fq","_1.fq",individuals[i,5], fixed = T), ".sai", sep = "");
bwa_aln2 = paste("bwa aln -t 6 -I -q 20 reference/HA412_trinity_noAltSplice_400bpmin.fa ",sub(".fq","_2.fq",individuals[i,1], fixed = T),"  >alignments/",sub(".fq","_2.fq",individuals[i,5], fixed = T), ".sai", sep = "")}
